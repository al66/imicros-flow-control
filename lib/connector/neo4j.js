...
class neo4j {
    ...
    async removeProcess (process) {
        ...
        let statement = "MATCH (n { ownerType: {ownerType}, ownerId: {ownerId} })-[:ASSIGNED]->(:Process { uid: {uid}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
        statement += "MATCH (p:Process { uid: {uid}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
    ...
    async removeEvent (event) {
        ...
        let statement = "MATCH (e:Event { uid: {uid}, ownerType: {ownerType}, ownerId: {ownerId} })-[:ASSIGNED]->(p:Process { uid: {processId}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
    ...
    async removeTask (task) {
        ...
        let statement = "MATCH (t:Task { uid: {uid}, ownerType: {ownerType}, ownerId: {ownerId} })-[:ASSIGNED]->(p:Process { uid: {processId}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
    ...
    async addGateway (gateway) {
        let params = {
            ...
            rule: gateway.rule ? await this.serializer.serialize(gateway.rule) : "",
            function: gateway.function ? await this.serializer.serialize(gateway.function) : ""
        };
        let statement = "MATCH (p:Process { uid: {processId}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
        statement += "WITH p ";
    ...
    async removeGateway (gateway) {
        ...
        let statement = "MATCH (g:Gateway { uid: {uid}, ownerType: {ownerType}, ownerId: {ownerId} })-[:ASSIGNED]->(p:Process { uid: {processId}, ownerType: {ownerType}, ownerId: {ownerId} }) ";
    ...
    async addSequence (connection) {
        ...
        statement += "SET r.type =  {type}, r.attributes = {attributes} ";
        statement += "RETURN { from: from.uid, to: to.uid, type: r.type  } AS connection ";
        let result = await this.run(statement, params);
        return result;
