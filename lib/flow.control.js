...
module.exports = {
    ...
    methods: {
        ...
        parseXml({ id, xmlData, objectName, ownerId, core }) {
            ...
            let bpmnProcess = jsonObj["bpmn:definitions"]?.[0]?.["bpmn:process"]?.[0] ??  null;
            if (bpmnProcess) {
                bpmnProcess.process = {
                    id: id || mapId(bpmnProcess?.attr?.[0]?.["@_id"] ?? null),
                    name: objectName,
                    ownerId: ownerId,
                    ...
                    bpmnProcess["bpmn:serviceTask"].forEach((t) => {
                        let task = {
                            ...
                            attributes: {
                                ...
                                prepFunction: _.get(t,"bpmn:extensionElements[0].fe:executionParameter[0].attr[0].@_prepFunction", null),
                                ruleset: _.get(t,"bpmn:extensionElements[0].fe:executionParameter[0].attr[0].@_ruleset", null),
                                template: _.get(t,"bpmn:extensionElements[0].fe:executionParameter[0].attr[0].@_template", null),
                                ...
                                serviceId: _.get(t,"bpmn:extensionElements[0].fe:executionParameter[0].attr[0].@_serviceId", null),
